...
This has been tested on a Canon A570IS, but it should be compatible with most Digic III point and shoots. Please [report issues](http://code.google.com/p/trackuino/issues/list) otherwise!

# Download #

Provided you have CHDK installed:

**Go to the [downloads area](http://code.google.com/p/trackuino/downloads/list) and get the "trackuino.lua" file. Then, copy it over to the CHDK\SCRIPTS directory in your camera's flash card.**
